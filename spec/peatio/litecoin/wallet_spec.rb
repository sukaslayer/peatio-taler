RSpec.describe Peatio::Taler::Wallet do
  let(:wallet) { Peatio::Taler::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Taler::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Taler::Wallet::SUPPORTED_SETTINGS))
    end
  end
